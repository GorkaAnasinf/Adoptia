...
-- Extiende shelters_nearby con filtros de especie/voluntariado/acogida y
-- el nº de animales publicados por protectora (para la lista/popup del mapa).

drop function if exists public.shelters_nearby(double precision, double precision, double precision);
...
comment on function public.shelters_nearby is
  'Protectoras verificadas cerca de un punto, con filtros de especie/voluntariado/acogida y nº de animales publicados (FEATURE-006).';
