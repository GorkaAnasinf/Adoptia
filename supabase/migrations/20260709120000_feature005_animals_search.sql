-- FEATURE-005: RPC de búsqueda pública de animales con filtros,
-- orden por distancia (PostGIS) y paginación.
--
-- SECURITY INVOKER (por defecto): la RLS de animals/shelters aplica dentro
-- de la función — anon solo ve publicados de protectoras verificadas.
...
comment on function public.animals_search is
  'Listado público de animales con filtros combinables, orden por distancia y paginación (FEATURE-005). Security invoker: RLS aplica.';
