...
- **Última actualización:** 2026-07-23 (FEATURE-060 hecha — badge «Urgente»: columna `animals.urgent`, filtro «Solo urgentes» y orden urgentes-primero en recientes, toggle en la ficha y badge en la card; ⚠️ una migración a aplicar. Antes hoy: FEATURE-059, IMPROVEMENT-031, captura de 5 items, FEATURE-035 Nivel 1, IMPROVEMENT-030, FEATURE-058).
