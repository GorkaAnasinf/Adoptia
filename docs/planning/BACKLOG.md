...
- **Bloqueos:** ninguno. **Pendiente de despliegue:** nada — IMPROVEMENT-028 **liberada a producción el 2026-07-19** (release `f274d98`, verificado en `adoptia-eight.vercel.app/mapa`; sin migraciones).
