...
- **Siguiente:** liberar FEATURE-031 — **requiere `supabase db push` de la migración `20260718100000` ANTES del release** (dry-run primero). Después: FEATURE-033 (alertas de búsqueda guardada, favorita del usuario) o FEATURE-032 (donaciones de particulares).
- **Bloqueos:** ninguno. **Pendiente de despliegue:** FEATURE-031 (migración `20260718100000`). Todo el ciclo de acogidas (FEATURE-029/030, IMPROVEMENT-025/026 + backfill) en producción.
...
- **Última actualización:** 2026-07-18 (FEATURE-031 cerrada — tablón de necesidades; migración pendiente de producción. Antes el mismo día: FEATURE-030 liberada. El 17: IMPROVEMENT-026 + backfill, FEATURE-029 e IMPROVEMENT-024/025 liberadas).
