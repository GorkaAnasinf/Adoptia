...
- **Bloqueos:** ninguno. **Pendiente de despliegue:** nada — la migración `20260718110000_feature032_donation_offers.sql` **aplicada en producción el 2026-07-18** (dry-run previo, confirmada con `migration list --linked`) y el release `cee7448` desplegado en Vercel (READY, alias `adoptia-eight.vercel.app`).
...
- **Última actualización:** 2026-07-18 (FEATURE-032 **liberada a producción** — donaciones de particulares. Antes el mismo día: FEATURE-033 descartada como duplicado de FEATURE-010 y FEATURE-031 liberada).
...
|------|--------|-----------|------|
| [FEATURE-034](items/FEATURE-034.md) | Rediseño de la home según wireframe Stitch (tanda de rediseño, pantalla 1) | alta | 0.5 |
<!-- RENDER:END -->
