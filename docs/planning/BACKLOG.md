...
- **Bloqueos:** ninguno. **Pendiente de despliegue:** nada — FEATURE-038 **liberada a producción el 2026-07-19** (release `bd1137d`, verificado en `adoptia-eight.vercel.app/perdidos-encontrados`; sin migraciones).
