...
- **Siguiente:** FEATURE-032 (donaciones de particulares). Probar en real el tablón con las cuentas de prueba. FEATURE-033 **descartada como duplicado de FEATURE-010** (2026-07-18): las alertas de búsqueda guardada ya están en producción desde el hito 0.3 (tabla, cron diario, baja un clic, RLS probada — verificación criterio a criterio en el item); deltas menores anotados allí (editar alerta, matching por edad).
...
- **Última actualización:** 2026-07-18 (FEATURE-033 descartada como duplicado de FEATURE-010; antes el mismo día FEATURE-031 **liberada a producción** — tablón de necesidades. El 17: IMPROVEMENT-026 + backfill, FEATURE-029 e IMPROVEMENT-024/025 liberadas).
