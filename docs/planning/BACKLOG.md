...
- **Bloqueos:** ninguno. **Pendiente de despliegue:** nada — todas las migraciones hasta `20260714140000_bug004` aplicadas en producción el 2026-07-14 (`supabase db push`).
