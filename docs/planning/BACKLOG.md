...
- **Siguiente:** liberar FEATURE-030 — **requiere `supabase db push` de la migración `20260717210000` ANTES del release** (dry-run primero). Después: FEATURE-031 (tablón de necesidades) o FEATURE-033 (alertas de búsqueda guardada, favorita del usuario).
- **Bloqueos:** ninguno. **Pendiente de despliegue:** FEATURE-030 (migración `20260717210000`). El resto del día ya en producción: `20260717150000` (FEATURE-029), `20260717180000` y `20260717200000` (IMPROVEMENT-026 + backfill).
...
- **Última actualización:** 2026-07-17 (FEATURE-030 cerrada — relevo de acogida; migración pendiente de producción. Antes el mismo día: IMPROVEMENT-026 + backfill, FEATURE-029 e IMPROVEMENT-024/025 liberadas a producción; FEATURE-029..033 capturadas).
