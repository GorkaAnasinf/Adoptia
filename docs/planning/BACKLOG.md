...
- **Progreso:** **FEATURE-036 hecha** (rama `feature/FEATURE-036-rediseno-listado`) — rediseño del listado /animales: panel de filtros tonal, título «Peludos buscando un hogar» con contador en terracota, flechas de paginación accesibles, `Reveal` en tarjetas, «Filtros (N)» en móvil y ayuda del slider deshabilitado. QA: suite **1121/1121 con RLS**, E2E área pública 4/4, lint y tsc limpios. Antes el mismo día: IMPROVEMENT-027 y FEATURE-034 (home, en producción).
...
- **Bloqueos:** ninguno. **Pendiente de despliegue:** nada — FEATURE-036 **liberada a producción el 2026-07-18** (release `ec3c98d`, verificado en `adoptia-eight.vercel.app/animales`: título y panel nuevos servidos; sin migraciones).
...
- **Última actualización:** 2026-07-18 (FEATURE-036 — rediseño del listado de animales, segunda pantalla de la tanda Stitch).
