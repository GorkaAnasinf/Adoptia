...
- **Bloqueos:** ninguno. **Pendiente de despliegue:** nada — la migración `20260717180000_improvement026_sync_animal_acogida.sql` **aplicada en producción el 2026-07-17** (dry-run previo, confirmada con `migration list --linked`) y el release `334f210` desplegado en Vercel (READY). FEATURE-029 también en producción (`20260717150000`, release `cdf53bf`).
...
- **Última actualización:** 2026-07-17 (IMPROVEMENT-026 cerrada y **liberada a producción** — trigger que sincroniza el estado del animal con su acogida. Antes el mismo día: FEATURE-029 liberada, IMPROVEMENT-024/025 liberadas, FEATURE-029..033 capturadas).
...
|------|--------|-----------|------|
| [FEATURE-030](items/FEATURE-030.md) | Relevo de acogida (emergencias del acogedor) | media | 0.5 |
