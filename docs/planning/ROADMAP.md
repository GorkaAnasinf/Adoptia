...
| [FEATURE-054](items/FEATURE-054.md) | Agenda de la protectora F2a — pintar días y cerrar rangos (batch) | desarrollo | media |
| [FEATURE-055](items/FEATURE-055.md) | Agenda de la protectora F3 — vistas anual (heatmap) y diaria (timeline) | recibido | media |
| [FEATURE-056](items/FEATURE-056.md) | Agenda de la protectora F2b — festivos, plantillas y copiar/pegar | recibido | media |
