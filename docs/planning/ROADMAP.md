...
| [BUG-011](items/BUG-011.md) | CI en rojo crónico — el job E2E falla en onboarding y citas (main lleva rojo varias features) | hecho | alta |
| [BUG-012](items/BUG-012.md) | El seed comercial no crea cuentas autenticables | desarrollo | alta |
...
| [FEATURE-045](items/FEATURE-045.md) | Rediseño del panel de la protectora (dashboard) al patrón Stitch | hecho | media |
| [FEATURE-046](items/FEATURE-046.md) | Layout del panel de la protectora a 2 columnas del wireframe Stitch | hecho | media |
| [FEATURE-047](items/FEATURE-047.md) | Solicitudes recientes clicables + badge de estado legible sobre foto | hecho | media |
| [FEATURE-048](items/FEATURE-048.md) | Mis animales" de la protectora a rejilla de tarjetas con búsqueda y acciones | hecho | media |
| [FEATURE-050](items/FEATURE-050.md) | Rediseño de "Solicitudes recibidas" (maestra/detalle) del panel | hecho | media |
...
| [FEATURE-063](items/FEATURE-063.md) | Jornadas de adopción F2 — recordatorios, aviso a la protectora y avisos por zona | hecho | media |
...
| [FEATURE-064](items/FEATURE-064.md) | Jornadas de adopción F3 — cierre con métricas hacia estadísticas e historias | hecho | baja |
...
| [IMPROVEMENT-035](items/IMPROVEMENT-035.md) | Añadir capturas de pantalla al manual de usuario | hecho | baja |
<!-- RENDER:END -->
