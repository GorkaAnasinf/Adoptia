...
| [FEATURE-053](items/FEATURE-053.md) | Agenda de la protectora F1 — calendario mensual con excepciones por día | desarrollo | media |
| [FEATURE-054](items/FEATURE-054.md) | Agenda de la protectora F2 — utilidades masivas de disponibilidad | recibido | media |
