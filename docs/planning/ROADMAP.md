...
### Hito 0.5 — 86% completado (12/14)

| Item | Título | Estado | Prioridad |
|------|--------|--------|-----------|
| [BUG-004](items/BUG-004.md) | Reservar cita" lleva a una página 404 | hecho | alta |
| [BUG-006](items/BUG-006.md) | El listado sirve la URL de YouTube como imagen de portada cuando el animal no tiene foto de portada | recibido | alta |
