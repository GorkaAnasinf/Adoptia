...
- **QA Scooby 7/7**. Suite **1009/1009 con RLS** (Supabase local), lint y `tsc` limpios, cobertura 82,4 % global / 96,7 % `src/lib`.
- **Producción (2026-07-17)**: migración aplicada con dry-run previo y confirmada (`migration list --linked`); release `cdf53bf` desplegado en Vercel (READY, `adoptia-eight.vercel.app`).
