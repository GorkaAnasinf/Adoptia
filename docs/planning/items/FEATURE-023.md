...
- **Despliegue**: migración `20260715180000` **aplicada en producción el 2026-07-15** (`db push`, confirmada con `migration list --linked`); `main` en la release 0.0.57. Verificada **antes** de desplegar (`db reset` + 903/903 + CI verde), a diferencia de FEATURE-022.
